    ...
    <Navbar className="bg-transparent px-0 py-4">
      <div className="flex items-center justify-between mx-4 sm:mx-11 lg:mx-4 text-blue-gray-900">
        <div className="flex items-center lg:hidden gap-x-1">
          <Button
            variant="gradient"
            className="inline-block rounded-md text-sm border-white border-[1px] px-2 py-1 hover:border-white"
          >
            <span>Sign in</span>
          </Button>
        </div>
        <div className="lg:flex lg:items-center">
          <a class="mr-lg-3 lg:mr-3 color-fg-inherit flex-order-2" href="https://github.com/" aria-label="Homepage" data-ga-click="(Logged out) Header, go to homepage, icon:logo-wordmark">
